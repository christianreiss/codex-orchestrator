// Package terminalui provides one terminal visual system for both engines.
// Capability detection, text safety, layout, and colors live here so the two
// launchers cannot drift as new status and control surfaces are added.
//
...
// Most status fields are printable ASCII. Keep their width and sanitization
// paths allocation-free while Unicode and terminal controls retain the full
// grapheme-aware validation below.
