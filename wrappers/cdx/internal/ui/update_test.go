...
func TestUpdateLinesAreUniformAndColoured(t *testing.T) {
	...
	cases := []struct {
		...
		{"progress", UpdateProgress(caps, "cdx", "wrapper", "0.6.41", "0.6.42"), "↻ · cdx · wrapper · 0.6.41 → 0.6.42 · updating…", "\033[96m"},
		{"complete", UpdateComplete(caps, "cdx", "wrapper", "0.6.42", true), "✓ · cdx · wrapper · 0.6.42 · updated, restarting…", "\033[32m"},
		{"install", UpdateProgress(caps, "cdx", "clx", "", ""), "↻ · cdx · clx · installing…", "\033[96m"},
