...
## Overview
- `cdx` is the local wrapper (shell script in `bin/cdx`) that **pulls canonical auth**, **runs Codex**, **pushes changes**, **reports usage**, and **self‑updates** (both Codex binary and the wrapper) using the Auth API.
