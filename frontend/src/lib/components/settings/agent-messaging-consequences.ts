  ...
  if (enabling) {
    return {
      ...
      consequences: [
        ...
        "Hosts pick it up on the next wrapper launch or successful background maintenance check, scheduled every 15 minutes. Managed content writes wait while another session holds the sync lock.",
