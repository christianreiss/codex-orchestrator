...
export const ROUTE_CAPABILITIES: Readonly<Record<string, RouteGuard>> = {
  ...
  'GET /admin/projects/:slug/summary': cap('projects.read'),
  'GET /admin/projects/:slug/feedback': cap('projects.read'),
  'GET /admin/projects/:slug/files': cap('projects.read'),
  'GET /admin/projects/:slug/files/:id': cap('projects.read'),
  ...
  'POST /admin/projects/:slug/archive': cap('projects.manage'),
  'POST /admin/projects/:slug/unarchive': cap('projects.manage'),
  'POST /admin/projects/:slug/feedback/:id': cap('projects.manage'),
