...
- Normalization defaults include `features.apps=true`, `features.guardian_approval=true`, `features.js_repl=true`, `features.multi_agent=true`, and `features.use_linux_sandbox_bwrap=true` when unset.
