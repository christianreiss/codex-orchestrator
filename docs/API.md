...
- File transfer (a fleet-wide, TTL'd pool of arbitrary files agents hand each other; the switch, its bounds and clearing a file require the owner, admin, or fleet role, while downloading the bytes requires owner or admin):
