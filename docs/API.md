...
- Feedback: `GET /projects/{slug}/feedback`, `POST /projects/{slug}/feedback`. Create bodies require `type` (`bug|feature|note|issue|test`), `title`, and `body`; new entries start with `status:"open"`.
