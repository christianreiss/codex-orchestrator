...
- Admin dashboard supports login + role-based access once at least one admin user exists; userless installs behave as before until the first admin is created.
