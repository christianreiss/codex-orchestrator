...
CODEX_HOST_SECURE_DEFAULT="__CODEX_HOST_SECURE__"
if [[ "$CODEX_HOST_SECURE_DEFAULT" == "__CODEX_HOST_SECURE__" ]]; then
  CODEX_HOST_SECURE_DEFAULT="1"
fi
CODEX_HOST_SECURE="${CODEX_HOST_SECURE:-$CODEX_HOST_SECURE_DEFAULT}"
