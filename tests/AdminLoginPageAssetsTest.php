...
final class AdminLoginPageAssetsTest extends TestCase
{
    public function testLoginPageLoadsDedicatedAssets(): void
    {
        ...
        $this->assertStringContainsString('/admin/assets/dashboard.css?v=2026-03-24-01', $html);
        $this->assertStringContainsString('/admin/assets/dashboard-mobile.css?v=2026-03-24-01', $html);
        $this->assertStringContainsString('/admin/assets/dashboard.js?v=2026-03-24-01', $html);
